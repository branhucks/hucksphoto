"""
Django settings for hucksphoto project.
...
SECRET_KEY = 'django-insecure-lua5*k(*)ky-6s8k-qogwp+@@xu4^2ienfl5ip8v!^&goyy0ca'
...
CSRF_TRUSTED_ORIGINS = ['https://hucksphoto.up.railway.app/']
...
WSGI_APPLICATION = 'hucksphoto.wsgi.application'
...
STATICFILES_DIRS = [
    # BASE_DIR / 'static',  # Uncomment if you have project-level static files
]
...
# Social Media Settings - for footer links
SOCIAL_MEDIA = {
    'instagram': 'https://instagram.com/hucksphoto',
}
